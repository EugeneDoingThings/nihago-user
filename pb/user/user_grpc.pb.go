...
type UserServiceClient interface {
	GetUser(ctx context.Context, in *SingleUser, opts ...grpc.CallOption) (*SingleUser, error)
...
func (c *userServiceClient) GetUser(ctx context.Context, in *SingleUser, opts ...grpc.CallOption) (*SingleUser, error) {
	out := new(SingleUser)
...
type UserServiceServer interface {
	GetUser(context.Context, *SingleUser) (*SingleUser, error)
...
func (UnimplementedUserServiceServer) GetUser(context.Context, *SingleUser) (*SingleUser, error) {
...
func _UserService_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUser(ctx, req.(*SingleUser))
	}
